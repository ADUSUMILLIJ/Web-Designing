...
function checkboxChangeHandler() {
  ...
  // To Show DELETE and EDIT buttons only for the checked rows
...
// To add a delete button to the DELETE column and handle row deletion
function addDeleteButton(row) {
  ...
  deleteButton.addEventListener("click", function () {
    ...
    if (confirm("Are you sure you want to delete " + studentName + "?")) {
      ...
      // Find and delete the main row
      table.deleteRow(rowIndex);

      // Find and delete the associated dropdown text row
      var detailRow = table.rows[rowIndex];
...
// To add an edit button to the EDIT column and handle editing popup
...
window.onload = function () {
  ...
  // To Add Edit and Delete buttons for existing rows
